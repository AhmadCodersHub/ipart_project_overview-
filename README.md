![image](https://github.com/user-attachments/assets/cae01bd0-fe13-4c7c-ba2a-0a9938c9a73c)
...
3. **Duplicate-Free Data**: Ensure no duplicate entries in the final dataset.
4. **CSV Output**: Save the consolidated data into a CSV file for easy sharing and analysis.

## Technologies Used
- **Python**: Primary programming language.
- **DrissionPage**: For handling dynamic pages and pagination.
